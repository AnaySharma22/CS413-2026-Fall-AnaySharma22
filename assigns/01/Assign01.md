...
Obtain the source program provided by the instructor and place it in
your repository:
...
Use AI the original program into the target programming language
Python~3.

Your prompt should ask the AI to preserve the behavior of the original
program as closely as possible.

You may ask follow-up questions or request corrections if the initial
translation is incomplete or incorrect.
